...
public class Requerimiento {
	...
	public List<BienRequerimiento> getListaRequerimeinto() {
		return listaRequerimeinto;
	}

	public void setListaRequerimeinto(List<BienRequerimiento> listaRequerimeinto) {
		this.listaRequerimeinto = listaRequerimeinto;
	}
